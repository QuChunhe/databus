...
/**
 * Created by Qu Chunhe on 2020-01-17.
 * copy from Jedis redis.clients.jedis.JedisFactory
 */
public class JedisClientFactory implements PooledObjectFactory<Jedis> {
    ...
    JedisClientFactory(final String host, final int port, final int connectionTimeout,
    ...
    JedisClientFactory(final URI uri, final int connectionTimeout, final int soTimeout,
                 final String clientName) {
    ...
    public PooledObject<Jedis> makeObject() throws Exception {
        ...
        final Jedis jedis = new JedisClient(hostAndPort.getHost(), hostAndPort.getPort(),
