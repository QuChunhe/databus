...
public class JedisClusterClient implements RedisClient {
    ...
    public Transaction multi() {
        throw new UnsupportedOperationException("JedisCluster does not support transaction");
    }
    ...
    public String restoreReplace(String key, int ttl, byte[] serializedValue) {
        throw new UnsupportedOperationException("JedisCluster does not support restoreReplace");
    }
    ...
    public Long move(String key, int dbIndex) {
        throw new UnsupportedOperationException("JedisCluster does not support move");
    }
    ...
    public Long bitpos(String key, boolean value) {
        throw new UnsupportedOperationException("JedisCluster does not support bitpos");
    }
    ...
    public ScanResult<Map.Entry<String, String>> hscan(String key, String cursor, ScanParams params) {
        throw new UnsupportedOperationException("JedisCluster does not support hscan with params");
    }
    ...
    public ScanResult<String> sscan(String key, String cursor, ScanParams params) {
        throw new UnsupportedOperationException("JedisCluster does not support sscan");
    }
